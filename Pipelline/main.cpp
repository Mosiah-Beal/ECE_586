...
int main() {
    ...
    std::vector<std::string> fileStandIn;
    fileStandIn.push_back("0x04210002");
    fileStandIn.push_back("0x04420003");
    fileStandIn.push_back("0x04210003");
    fileStandIn.push_back("0x04630004");
    fileStandIn.push_back("0x04840004");
    fileStandIn.push_back("0x04A50005");
    fileStandIn.push_back("0x00000000");
    fileStandIn.push_back("0x00000000");
    fileStandIn.push_back("0x00000000");
    fileStandIn.push_back("0x00000000");
    fileStandIn.push_back("0x00000000");
    fileStandIn.push_back("0x44000000");
...
/*
    ...
    */
    ...
    do {
        ...
        nxtInstr = std::stoi(fileStandIn.at(instrIndex++), 0, 16); // convert to int for parsing
        pipeline.moveStages(nxtInstr); // move stages in pipeline
    } while (pipeline.checkHalt(nxtInstr) && instrIndex < (int) fileStandIn.size());
